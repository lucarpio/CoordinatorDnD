...
export default function ClaimCharacterModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg bg-[#0e1017] border border-zinc-800 rounded-2xl sm:rounded-3xl p-6 sm:p-7 shadow-2xl space-y-6 overflow-hidden">
        {/* Glow de fondo */}
        <div className="absolute -right-20 -top-20 w-52 h-52 bg-amber-500/10 rounded-full blur-3xl pointer-events-none" />

        {/* Botón de cerrar (solo si ya tenía un personaje o puede cerrar) */}
        {canDismiss && (
          <button
            onClick={onClose}
